...
class WindowForm:
    def __init__(self, menu_box):
        ...
        title_label.set_markup("Ações sobre a Window")
        ...
        menu_box.add_element(self.move_box.element)

    def connect_panning_buttons(self, on_up, on_left, on_right, on_down):
        self.move_box.external_on_button_up = on_up
        self.move_box.external_on_button_left = on_left
        self.move_box.external_on_button_right = on_right
        self.move_box.external_on_button_down = on_down
...
class MoveBox:
    def __init__(self):
        ...
        panning_label = Gtk.Label(label="Movimentar Window:")
